...
<div style="color:white;margin-left:250px;margin-bottom:50px;margin-top:20px;font-size:30px;font-family:Bodoni MT Black;">Sistema de Inventario</div>
	...
	<div class="container-fluid">
		...
		<div class="col-md-8">
			...
			<div class="panel-heading">
				<h3 class="panel-title">Por favor accede</h3>
			</div>
				...
				<!-- logn form -->
					...
					<center>
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-2" for="un">Usuario:</label>
					    <div class="col-sm-10">
					  ...
					  <div class="form-group"> 
					    <div class="col-sm-offset-2 col-sm-10">
					      <button type="submit" class="btn btn-default">Acceso
