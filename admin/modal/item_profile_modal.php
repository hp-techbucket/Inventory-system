				...
				<form class="form-horizontal" role="form" id="update-item-form">
					<input type="hidden" id="iID">
					  <div class="form-group">
					    <label class="control-label col-sm-3">Nombre del Articulo:</label>
					    <div class="col-sm-9">
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3">No. de Serial:</label>
					    <div class="col-sm-9"> 
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3">Fecha de Compra:</label>
					    <div class="col-sm-9"> 
					   ...
					   <div class="form-group">
					    <label class="control-label col-sm-3">Encargado:</label>
					    <div class="col-sm-9"> 
					   ...
					   <div class="form-group">
					    <label class="control-label col-sm-3">Condicion:</label>
					    <div class="col-sm-9"> 
