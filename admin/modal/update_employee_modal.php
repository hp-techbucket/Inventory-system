				...
				<!-- main form -->
					...
					<input type="hidden" id="update-eid">
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="update-fN">Primer Nombre:</label>
					    <div class="col-sm-9">
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="update-mN">Segundo Nombre:</label>
					    <div class="col-sm-9">
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="update-lN">Apellidos:</label>
					    <div class="col-sm-9">
				      ...
				      <div class="form-group">
					    <label class="control-label col-sm-3" for="update-position">Cargo:</label>
					    <div class="col-sm-9">
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="update-office">Departamento:</label>
					    <div class="col-sm-9">
					    ...
					    <div class="form-group">
					    <label class="control-label col-sm-3" for="update-type">Tipo de cuenta:</label>
					    <div class="col-sm-9">
					  ...
					  <div class="form-group"> 
					    <div class="col-sm-offset-2 col-sm-10">
					      <button type="submit" class="btn btn-primary" value="addEmployee">Guardar
