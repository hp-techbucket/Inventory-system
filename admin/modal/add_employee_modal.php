				...
				<div class="alert alert-info">
					...
					<form class="form-horizontal" role="form" id="add-employee-form">
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="fN">Nombre:</label>
					    <div class="col-sm-9">
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="lN">Apellidos:</label>
					    <div class="col-sm-9">
				      ...
				      <div class="form-group">
					    <label class="control-label col-sm-3" for="position">Cargo:</label>
					    <div class="col-sm-9">
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="position">Departamento:</label>
					    <div class="col-sm-9">
