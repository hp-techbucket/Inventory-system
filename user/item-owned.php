  ...
  <nav class="navbar navbar-inverse" style="margin-top:-18px;">
  	<div class="container-fluid">
  	  ...
  	  <ul class="nav navbar-nav">
         ...
         <li>
          <a href="request.php"><span class="glyphicon glyphicon-tag"></span> Solicitudes</a>
        </li>
  	     ...
  	     <li class="dropdown">
            <a class="dropdown-toggle" id="user-account" data-toggle="dropdown" href="#"></a>
    	      ...
    	      <ul class="dropdown-menu">
    	        <li><a href="#modal-changepass" id="change-password-button" data-toggle="modal">Cambiar Contraseña</a></li>
